...
lcd.begin(20,4); //inisialisasi 20x4 LCD
lcd.setCursor(0,0); //set LCD pada kolom pertama dan baris pertama
lcd.print("Monitoring Suhu");
lcd.setCursor(0,1); //set LCD pada kolom pertama dan baris kedua
...
nilai_ADC_sensor = analogRead(sensor_Pin); //mengubah nilai ADC sensor ke tegangan lalu ke Celcius  
